...
public final class RSSExpandedReader extends AbstractRSSReader {
  ...
  private List<ExpandedPair> checkRows(ArrayList<ExpandedRow> collectedRows, int currentRow) throws NotFoundException {
    for (int i = currentRow; i < rows.size(); i++) {
      ...
      if (isValidSequence(this.pairs)) {
        ...
        ArrayList<ExpandedRow> rs = new ArrayList<>(collectedRows);
        rs.add(row);
        try {
